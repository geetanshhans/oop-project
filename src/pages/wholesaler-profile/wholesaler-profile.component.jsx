...
const useStyles = theme => ({
  ...
  class WholesalerProfile extends React.Component {
    ...
    render(){
     ...
     const { firstName,lastName,mobileNumber,email,type } = this.state;
    return (
...
export default connect(mapStateToProps)(withStyles(useStyles)(WholesalerProfile));